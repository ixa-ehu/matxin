 ...
 public:
   ...
   ///////////////////////////////OPTIONS OF MATXIN///////////////////////////////////////
    ...
    config(char **argv) {
      ...
      int flush,noflush, afx,noafx, loc,noloc, numb,nonumb, punt, nopunt,
          date, nodate, quant, noquant, dict, nodict, prob, noprob,
          nec, nonec, dup, nodup, retok, noretok,  coref,nocoref, orto, noorto, trace, notrace,
      ...
      char *cf_flush, *cf_afx, *cf_loc, *cf_numb, *cf_punt, *cf_date, *cf_quant,
           *cf_dict, *cf_prob, *cf_nec, *cf_dup, *cf_retok,  *cf_coref, *cf_orto, *cf_Usubcat,
  ...
  ERROR_CRASH("Error creating context. Not enough memory?");
      ...
      SetBooleanOptionCF(cf_trace, DoTrace,"DoTrace");
      SetBooleanOptionCF(cf_vtrace, DoVerbTrace,"DoVerbTrace");
      SetBooleanOptionCF(cf_gtrace, DoGenTrace,"DoGenTrace");
      SetBooleanOptionCF(cf_ptrace, DoPrepTrace,"DoPrepTrace");
      SetBooleanOptionCF(cf_first_case, first_case,"FirstCase");
      SetBooleanOptionCF(cf_Urules, UsePrepRules, "UsePrepRules");
      SetBooleanOptionCF(cf_Usubcat, UseSubcat,"UseSubcat");
      SetBooleanOptionCF(cf_Utripletes, UseTripletes,"UseTripletes");
      SetBooleanOptionCF(cf_Lrules, UseLexRules, "UseLexRules");
